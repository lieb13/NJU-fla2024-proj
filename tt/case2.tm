...
#Q = {check,square,cmp,sq_add,sq_bak_lm,sq_bak_x,restore,restore1,restore2,restore3,add,add1,accept,acc_cls,acc_t,acc_r,acc_u,acc_e,reject,rej_cls,rej_f,rej_l,rej_a,rej_s,rej_e,halt,rej_halt}
#S = {1}
